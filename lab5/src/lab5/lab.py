...
def a():
    ...
    logger.info(f"\"Regularization\" network with no regularization\nNetwork weights:\n{reg_net.weights}")
...
def b():
    ...
    for lambda_param in lambda_values:
        ...
        reg_net.fit(X_train, y_train)
        logger.info(f"Regularization network with lambda = {lambda_param}\nNetwork weights:\n{reg_net.weights}")
...
def c():
    ...
    logger.info(f"RBF network with {n_neurons} neurons\nNetwork weights:\n{rbf_net.weights}")
